...
const DICT = {
  zh: {
    ...
    'camera.rotation': '旋转（烘焙进视频流，顺时针 0/90/180/270）', 'camera.device': '设备路径',
  ...
  en: {
    ...
    'camera.rotation': 'Rotation (baked into stream, clockwise 0/90/180/270)', 'camera.device': 'Device path',
