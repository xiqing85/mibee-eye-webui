...
const DICT = {
  zh: {
    ...
    'camera.rotation': '旋转（烘焙进视频流）', 'camera.device': '设备路径',
    'camera.hflip': '水平翻转（烘焙进视频流）', 'camera.vflip': '垂直翻转（烘焙进视频流）',
    rotationOff: '不旋转', rotationCW: '顺时针', rotationCCW: '逆时针',
    flipH: '设备级水平翻转', flipV: '设备级垂直翻转', flipApplied: '翻转设置已应用',
    rotateBtn: '设备级旋转（顺时针 90°）', rotateApplied: '旋转已应用：{deg}°',
    qualityBtn: '清晰度切换（当前：{q}）', qualityMain: '高清（主码流）', qualitySub: '流畅（子码流）',
    ...
    'watermark.text': '自定义文案',
    'watermark.show_timestamp': '显示实时时间',
    'watermark.timestamp_format': '时间格式（strftime 子集）',
    'watermark.position': '位置',
    'watermark.font_size': '字号（像素高）',
    'watermark.font_path': '字体文件路径（留空=内置 ASCII 字体，配 CJK 字体后支持中文）',
    'protocols.watermark': '视频水印',
    'protocols.watermark.enabled': '启用水印',
    'protocols.watermark.text': '自定义文案',
    'protocols.watermark.show_timestamp': '显示实时时间',
    'protocols.watermark.timestamp_format': '时间格式（strftime 子集）',
  ...
  en: {
    ...
    'camera.rotation': 'Rotation (baked into stream)', 'camera.device': 'Device path',
    'camera.hflip': 'Horizontal flip (baked into stream)', 'camera.vflip': 'Vertical flip (baked into stream)',
    rotationOff: 'no rotation', rotationCW: 'clockwise', rotationCCW: 'counter-clockwise',
    flipH: 'Device-level horizontal flip', flipV: 'Device-level vertical flip', flipApplied: 'Flip applied',
    rotateBtn: 'Device rotation (90° clockwise)', rotateApplied: 'Rotation applied: {deg}°',
    qualityBtn: 'Quality (current: {q})', qualityMain: 'HD (main stream)', qualitySub: 'Sub (low bandwidth)',
    ...
    'watermark.text': 'Custom text',
    'watermark.show_timestamp': 'Show real-time clock',
    'watermark.timestamp_format': 'Time format (strftime subset)',
    'watermark.position': 'Position',
    'watermark.font_size': 'Font size (px height)',
    'watermark.font_path': 'Font file path (empty = built-in ASCII font; set a CJK font for Chinese text)',
    'protocols.watermark': 'Video Watermark',
    'protocols.watermark.enabled': 'Enable watermark',
    'protocols.watermark.text': 'Custom text',
    'protocols.watermark.show_timestamp': 'Show real-time clock',
    'protocols.watermark.timestamp_format': 'Time format (strftime subset)',
