...
const DICT = {
  zh: {
    ...
    noCamera: '没有可用的相机',
    aiModel: 'AI 模型', aiModelUnavailable: '模型文件缺失，不可切换',
    aiModelCustom: '自定义模型路径（配置 model_path 覆盖）',
    aiModelSwitched: '已切换到 {model}', aiModelSwitchFail: '模型切换失败',
    aiModelUploaded: '已上传 {model}', aiModelUploadFail: '模型上传失败', uploadModel: '上传模型',
    aiUpload: '上传模型', aiUploadFamily: '类型', aiUploadFail: '模型上传失败',
    aiUploadFamily: '解码族', aiUploadBtn: '上传模型',
    aiModelUploaded: '已上传模型 {id}', aiModelUploadFail: '模型上传失败',
  ...
  en: {
    ...
    aiModel: 'AI Model', aiModelUnavailable: 'Model file missing on this device',
    aiModelCustom: 'Custom model path (model_path override)',
    aiModelSwitched: 'Switched to {model}', aiModelSwitchFail: 'Model switch failed',
    aiModelUploaded: 'Uploaded {model}', aiModelUploadFail: 'Model upload failed', uploadModel: 'Upload',
    aiUpload: 'Upload model', aiUploadFamily: 'Type', aiUploadFail: 'Model upload failed',
    aiUploadFamily: 'Family', aiUploadBtn: 'Upload model',
    aiModelUploaded: 'Uploaded model {id}', aiModelUploadFail: 'Model upload failed',
